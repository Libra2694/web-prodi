...
<head>
    ...
    <title>@yield('title', 'Program Studi TRPL - Politeknik Jambi')</title>
            ...
            <a class="navbar-brand" href="{{ route('home') }}">
                <div class="d-flex align-items-center">
                    <div class="me-3" style="width: 60px; height: 60px;">
                        <img src="{{ asset('image/logo.png') }}" alt="TRPL Logo" class="img-fluid" style="max-width: 100%; height: auto;">
                    </div>
                    <div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('profil*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            PROFIL
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('profil.sejarah') }}">Sejarah Singkat</a></li>
                            ...
                            <li><a class="dropdown-item" href="{{ route('profil.sambutan') }}">Sambutan Kaprodi</a></li>
                            <li><a class="dropdown-item" href="{{ route('profil.dosen') }}">Dosen</a></li>
                            <li><a class="dropdown-item" href="{{ route('profil.akreditasi') }}">Akreditasi</a></li>
                        </ul>
                    </li>
                    
                    <!-- Academic Dropdown -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('academic*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            AKADEMIK
                        </a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('publication*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            PUBLIKASI
                        </a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('student*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            KEMAHASISWAAN
                        </a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('information*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            INFORMASI
                        </a>
                        <ul class="dropdown-menu">
